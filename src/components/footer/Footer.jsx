...
function Footer() {
  const footerStyle= {backgroundColor:'hsl(233, 26%, 24%)', 
                      display:'flex',  
    ...
    <div className='footer' style={footerStyle}>
      ...
      <div className='socials'>
        <ul>
          ...
          <li><a href="#"><img src={pin} alt="" /></a></li>
        </ul>
      </div>
      <div className='links' style={links}>
          ...
          <a style={{color:'#fff'}} href="support">Support</a>
